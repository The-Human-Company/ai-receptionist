...
// CONFIGURATION
// ============================
const VAPI_PUBLIC_KEY = '0b7fd58a-75fc-42e0-82cb-07909f412c8a';
const VAPI_ASSISTANT_ID_BUSINESS = 'af31b79d-92e1-4888-905d-c15d01fd7751';
const VAPI_ASSISTANT_ID_AFTERHOURS = '45bddc18-ab13-40b5-85ca-d5713a54a891';
...
async function toggleCall() {
    if (callActive) {
        ...
        updateUI('connecting');
        try {
            const assistantId = currentMode === 'business'
                ? VAPI_ASSISTANT_ID_BUSINESS
                : VAPI_ASSISTANT_ID_AFTERHOURS;
